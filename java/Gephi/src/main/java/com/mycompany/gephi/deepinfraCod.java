// Criação das sumarizações com o qwen no deepinfra
...
public class deepinfraCod {
    ...
    static final String MODELO_DEEPINFRA = "Qwen/Qwen3.5-2B";

    // Nome que será salvo no banco
    static final String LLM = "qwen3.5:2b";
    ...
    static void processarArquivo(String caminhoArquivo) throws Exception {
        ...
        var inputStream = deepinfraCod.class
                .getClassLoader()
